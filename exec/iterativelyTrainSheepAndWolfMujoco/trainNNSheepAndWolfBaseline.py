...
from src.constrainedChasingEscapingEnv.policies import RandomPolicy, HeatSeekingContinuesDeterministicPolicy
...
def main():
    ...
    maxRunningSteps = 20 #20
    sheepAliveBonus = 1 / maxRunningSteps
    wolfAlivePenalty = -sheepAliveBonus

    sheepTerminalPenalty = -1
    wolfTerminalReward = -sheepTerminalPenalty
    ...
    transit = TransitionFunction(physicsSimulation, isTerminal, numSimulations)
    ...
    combinePathParametersWithAgentId = lambda agentId: \
        combineDict(fixedParameters, {'agentId': agentId})
...
# load sheep baseline for init iteration
    ...
    numTrajectoriesPerIteration = 1000#1000
    ...
    for agentId in trainableAgentIds:
        ...
        pathParameters = combinePathParametersWithAgentId(agentId)

...
def main():
    ...
    DIRNAME = os.path.dirname(__file__)
    dataSetDirectory = os.path.join(DIRNAME, '..', '..', 'data', 'evaluateResNN',
                                    'trajectories')
    ...
    rewardFunction = RewardFunctionAvoidCollisionAndWall(aliveBonus, deathPenalty, safeBound, wallDisToCenter, wallPunishRatio, velocityBound, isCollided, getWolfPos, getWolfVelocity)
    ...
    NNModelFixedParameters = {'agentId': wolfId, 'maxRunningSteps': dataSetMaxRunningSteps, 'numSimulations': dataSetNumSimulations, 'killzoneRadius':killzoneRadius}

    NNModelSaveDirectory = os.path.join(DIRNAME, '..', '..', 'data', 'evaluateResNN', 'trainedRes2WolfModels')

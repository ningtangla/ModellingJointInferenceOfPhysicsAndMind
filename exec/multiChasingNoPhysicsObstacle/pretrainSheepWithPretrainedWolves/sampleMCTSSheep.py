...
def main():
    ...
    maxRunningSteps = 50
    numSimulations = 300
<<<<<<< HEAD:exec/multiChasingNoPhysicsObstacle/trainSheepWithPretrainedWolves/sampleMCTSSheep.py
    killzoneRadius = 80
=======
    killzoneRadius = 90
>>>>>>> e497809233977cb250782b08efc1fa87a5f092de:exec/multiChasingNoPhysicsObstacle/pretrainSheepWithPretrainedWolves/sampleMCTSSheep.py

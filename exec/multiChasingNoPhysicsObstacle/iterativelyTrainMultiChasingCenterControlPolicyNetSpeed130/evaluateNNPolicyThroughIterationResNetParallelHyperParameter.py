...
def main():
    ...
    manipulatedVariables['otherIteration'] = [-999] + list(range(0, 1700, 400))
    ...
    dirName = os.path.dirname(__file__)
    trajectoryDirectory = os.path.join(dirName, '..', '..', '..', 'data', 'multiAgentTrain', 'multiMCTSAgentResNetNoPhysicsCenterControlObstacleSpeed130', 'evaluateTrajectories')
    ...
    plt.suptitle('SheepNNResnet speed130')
    plt.legend(loc='best')
    plt.show()

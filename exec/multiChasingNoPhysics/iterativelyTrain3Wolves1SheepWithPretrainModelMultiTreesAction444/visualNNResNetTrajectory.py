...
def main():
    ...
    startSampleIndex = 1
    endSampleIndex = 100
    parametersForTrajectoryPath['numTrajectoriesPerIteration'] = 1
    numTrainStepEachIteration = parametersForTrajectoryPath['numTrainStepEachIteration'] = 1
    parametersForTrajectoryPath['selfIteration'] = 0
    parametersForTrajectoryPath['otherIteration'] = 0
    parametersForTrajectoryPath['sampleIndex'] = (startSampleIndex, endSampleIndex)
    ...
    while True:
        ...
        if renderOn:
            ...
            circleSize = 10
            saveImage = False
            saveImageDir = os.path.join(dirName, '..', '..', '..', 'data', 'demoImg' + str(parametersForTrajectoryPath['selfIteration']) + '-' + str(parametersForTrajectoryPath['otherIteration']))

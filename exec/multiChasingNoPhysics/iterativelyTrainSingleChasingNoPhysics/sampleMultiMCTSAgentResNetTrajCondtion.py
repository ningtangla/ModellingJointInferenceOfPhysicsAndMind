...
from src.constrainedChasingEscapingEnv.envNoPhysics import  TransitionFunction, ResetUniform#IsTerminal,
...
def main():
    ...
    if not os.path.isfile(trajectorySavePath):
        ...
        NNModelSaveDirectory = os.path.join(dirName, '..', '..', 'data','multiAgentTrain', 'multiMCTSAgentResNet', 'NNModelRes')

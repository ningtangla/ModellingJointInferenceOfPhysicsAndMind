...
def trainOneCondition(manipulatedVariables):
    ...
    DIRNAME = os.path.dirname(__file__)
    dataSetDirectory = os.path.join(dirName, '..', '..', '..', '..', 'data', '3wolves1sheep', 'trainWolvesThreeCenterControlAction444', 'trajectories')
...
# augment
    ...
    preProcessedTrajectories = [agument(timeStep) for timeStep in unaugmentPreProcessedTrajectories]
###

...
def main():
    ...
    DIRNAME = os.path.dirname(__file__)
    dataSetDirectory = os.path.join(dirName, '..', '..', '..', 'data', '3wolves1sheep', 'trainSheepInMultiChasingNoPhysicsThreeWolves', 'trajectories')
    ...
    getWolf3Pos = GetAgentPosFromState(wolf3Id, xPosIndex)
    ...
    playIsTerminalByWolf3 = IsTerminal(playKillzoneRadius, getSheepPos, getWolf3Pos)

    playIsTerminal = lambda state: playIsTerminalByWolf1(state) or playIsTerminalByWolf2(state) or playIsTerminalByWolf3(state)

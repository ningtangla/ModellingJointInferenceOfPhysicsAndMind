...
def trainOneCondition(manipulatedVariables):
    ...
    DIRNAME = os.path.dirname(__file__)
    dataSetDirectory = os.path.join(dirName, '..', '..', '..', 'data','evaluateSupervisedLearning', 'trainWolfWithSingleSheepNoPhysics', 'trajectories')
    ...
    playIsTerminal = IsTerminal(getWolfOneXPos, getSheepXPos, killzoneRadius)
    ...
    NNModelSaveDirectory = os.path.join(dirName, '..', '..', '..', 'data', 'evaluateSupervisedLearning', 'trainWolfWithSingleSheepNoPhysics', 'trainedResNNModels')

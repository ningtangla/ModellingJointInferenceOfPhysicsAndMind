...
def main():
    ...
    manipulatedVariables['selfIteration'] = [6000]#list(range(0,6001,6000))
    manipulatedVariables['otherIteration'] = [6000]#list(range(0,6001,6000))
    ...
    generateTrajectoriesCodeName = 'sampleConditionTraj.py'
    evalNumTrials = 6

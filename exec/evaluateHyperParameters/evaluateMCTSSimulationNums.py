...
def main():
    ...
    manipulatedVariables['iteration'] = [0, 1000, 2000,2999]
    manipulatedVariables['numSimulations'] =[50,100,150,200] #E[50, 100, 150, 200]
    ...
    dirName = os.path.dirname(__file__)
    trajectoryDirectory = os.path.join(dirName, '..', '..', 'data', 'evaluateHyperParameters',

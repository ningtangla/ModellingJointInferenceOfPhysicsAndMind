...
def main():
    ...
    getPlayToTrain = lambda numTrialsPerIteration: PlayToTrain(numTrialsPerIteration, sampleTrajectory,
                                                               getTrajectorySavePath, getPolicy, dumpToPickle)
    getTrainToPlay = lambda learningRate: TrainToPlay(getTrain(numTrainStepsPerIteration, learningRate), getModelSavePath)
    iterativePlayAndTrain = IterativePlayAndTrain(numTrainStepsPerIteration, getPlayToTrain, getTrainToPlay,
                                                  preProcessTrajectories, saveToBuffer, getSampleBatchFromBuffer, getModel)

    toSplitFrame.groupby(levelNames).apply(iterativePlayAndTrain)

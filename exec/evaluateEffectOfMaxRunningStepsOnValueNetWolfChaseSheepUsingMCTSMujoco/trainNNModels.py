...
class PreProcessTrajectories:
    def __init__(self, addValuesToTrajectory, removeTerminalTupleFromTrajectory, processTrajectoryForNN,
        ...
        self.numDataPointsToReturn = numDataPointsToReturn
    ...
    def __call__(self, trajectories):
        ...
        print("len all data points: ", len(allDataPoints))
        dataPointsToReturn = random.sample(allDataPoints, self.numDataPointsToReturn)
        trainData = [list(varBatch) for varBatch in zip(*dataPointsToReturn)]
...
def main():
    ...
    preProcessTrajectories = PreProcessTrajectories(addValuesToTrajectory, removeTerminalTupleFromTrajectory,
                                                    processTrajectoryForNN, numDataPointsToReturn)

...
def main():
    ...
    trajectoriesSaveDirectory = os.path.join(dirName, '..', '..', '..', 'data','multiAgentTrain', 'multiMCTSAgentPolicyNetObstacle','demoTrajectories')
    ...
    if not os.path.isfile(trajectorySavePath):
        ...
        playKillzoneRadius=0
        isTerminal = IsTerminal(playKillzoneRadius, getSheepXPos, getWolfXPos)
        ...
        if renderOn:
            ...
            saveImage = True
            demoDirectory = os.path.join(dirName, '..', '..', '..', 'data', 'multiAgentTrain', 'multiMCTSAgentPolicyNetObstacle', 'NNdemo',str(sheepIteration))

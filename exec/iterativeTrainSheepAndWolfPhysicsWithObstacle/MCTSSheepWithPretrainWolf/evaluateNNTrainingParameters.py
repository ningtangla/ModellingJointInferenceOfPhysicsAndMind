...
def main():
    ...
    getWolfXPos = GetAgentPosFromState(wolfOneId, xPosIndex)
...
# generate trajectory parallel
    ...
    def calculateSuriveRatio(trajectory):
           ...
           count = np.array([lenght<10, lenght>=10 and lenght<20,lenght>=20])
           return count
    ...
    plt.suptitle('wolf with RandomSheep in Physics with Obstacle')
    plt.legend(loc='best')
    plt.show()

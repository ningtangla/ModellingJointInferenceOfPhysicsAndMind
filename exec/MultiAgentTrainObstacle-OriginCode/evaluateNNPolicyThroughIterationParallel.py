...
def main():
    ...
    manipulatedVariables['selfIteration'] = [0, 2000,3000,5000,8000]#list(range(0,6001,6000))
    manipulatedVariables['otherIteration'] = [0, 2000,3000,5000,8000]#list(range(0,6001,6000))
    ...
    dirName = os.path.dirname(__file__)
    NNModelSaveDirectory = os.path.join(dirName, '..', '..', 'data','multiAgentTrain', 'multiMCTSAgentObstacleOriginEnv', 'NNModel')
    ...
    dirName = os.path.dirname(__file__)
    trajectoryDirectory = os.path.join(dirName, '..', '..', 'data','multiAgentTrain', 'multiMCTSAgentObstacleOriginEnv', 'evaluateTrajectories')

...
def main():
    ...
    manipulatedVariables['selfIteration'] = [0, 500,1000,1500,2000,4000]#list(range(0,6001,6000))
    manipulatedVariables['otherIteration'] =[0, 500,1000,1500,2000,4000]#list(range(0,6001,6000))
    ...
    NNModelSaveDirectory = os.path.join(dirName, '..', '..', '..', 'data',
                                        'multiAgentTrain', 'originVersionObstacle', 'NNModel')
    ...
    trajectoryDirectory = os.path.join(dirName, '..', '..', '..', 'data',
                                        'multiAgentTrain', 'originVersionObstacle', 'evaluateTrajectories')

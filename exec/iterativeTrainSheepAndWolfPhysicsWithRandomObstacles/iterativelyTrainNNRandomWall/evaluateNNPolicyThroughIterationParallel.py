...
def main():
    ...
    manipulatedVariables['selfIteration'] = list(range(0,5001,500))#[0, 4000,8000,16000,20000]#list(range(0,6001,6000))
    manipulatedVariables['otherIteration'] = list(range(0,5001,500))#[0, 4000,8000,16000,20000]#list(range(0,6001,6000))
    ...
    generateTrajectoriesCodeName = 'generateMultiAgentEvaluationTrajectoryWithObstacle.py'
    evalNumTrials = 18

...
def main():
    ...
    if not os.path.isfile(trajectorySavePath):
        ...
        reset = ResetUniformForLeashed(physicsSimulation, qPosInit, qVelInit, numAgent, tiedAgentId, ropePartIndex, maxRopePartLength, qPosInitNoise, qVelInitNoise)

        # sample trajectory
        selectSoftmaxAction = SelectSoftmaxAction(beta)
        chooseActionList = [chooseGreedyAction, chooseGreedyAction, selectSoftmaxAction, chooseGreedyAction]
...
# multiAgent RewardFunctionForRollout
        ...
        reasonMindList[distractorId][sheepId] = lambda policy: policy
        reasonMindList[distractorId][wolfId] = lambda policy: policy
        reasonMindList[distractorId][masterId] = lambda policy: policy

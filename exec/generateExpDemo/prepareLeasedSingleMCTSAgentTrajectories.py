...
def main():
    ...
    trajectoryFixedParameters = {'agentId': 30, 'maxRunningSteps':maxRunningSteps, 'killzoneRadius':killzoneRadius, 'numSimulations':numSimulations}
    ...
    minLength = 125
    minDeviation = math.pi/8
    minDistractorMoveDistance = 1

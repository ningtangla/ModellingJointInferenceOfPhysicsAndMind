...
def main():
    ...
    trajectoryFixedParameters = {'agentId': distractorId, 'maxRunningSteps':maxRunningSteps, 'killzoneRadius':killzoneRadius, 'numSimulations':numSimulations}

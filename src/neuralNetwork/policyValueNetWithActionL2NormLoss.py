...
class GenerateModelActionL2Loss:
        ...
        with graph.as_default():
            ...
            with tf.name_scope("evaluate"):
                with tf.name_scope("action"):
                    tactionLoss_ = tf.losses.mean_squared_error(actionDistributions_, groundTruthAction_)/self.numActionSpace
...
class TrainWithCustomizedFetchesActionL2Loss:
...
class ApproximatePolicyActionL2Loss:
...
class ApproximateValueActionL2Loss:
